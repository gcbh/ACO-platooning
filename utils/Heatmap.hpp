...
public:
    ...
    void createDefaultHeatMapGradient()
    {
        ...
        color.push_back(ColorPoint(0.25f, 0, 0.57f,   0.25f));     // Cyan.
        color.push_back(ColorPoint(0.5f, 0, 0.5f,   0.5f));      // Green.
        color.push_back(ColorPoint(0.75f, 0, 0.25f,   0.75f));     // Yellow.
